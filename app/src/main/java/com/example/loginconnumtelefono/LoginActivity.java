package com.example.loginconnumtelefono;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSendOTPBtn = findViewById(R.id.btnenviar);
        processText = findViewById(R.id.tv);
        countryCodeEdit = findViewById(R.id.contryy);
        phoneNumberEdit = findViewById(R.id.numero);
        ...
        mSendOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!country_code.isEmpty() || !phone.isEmpty()){
                    ...
                    processText.setText("Ingrese el código del país y el número de teléfono");
        ...
        mCallBacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                processText.setText("OTP a sido enviado");
                processText.setVisibility(View.VISIBLE);
